...
public class CustomProcessDiagramGenerator extends DefaultProcessDiagramGenerator implements CustomProcessDiagramGeneratorI {
    ...
    protected Map<Class<? extends BaseElement>, DefaultProcessDiagramGenerator.ActivityDrawInstruction> activityDrawInstructions = new HashMap<>();
    protected Map<Class<? extends BaseElement>, DefaultProcessDiagramGenerator.ArtifactDrawInstruction> artifactDrawInstructions = new HashMap<>();
    ...
    public CustomProcessDiagramGenerator(final double scaleFactor) {
        // start event
        activityDrawInstructions.put(StartEvent.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // signal catch
        activityDrawInstructions.put(IntermediateCatchEvent.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // signal throw
        activityDrawInstructions.put(ThrowEvent.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // end event
        activityDrawInstructions.put(EndEvent.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // task
        activityDrawInstructions.put(Task.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // user task
        activityDrawInstructions.put(UserTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // script task
        activityDrawInstructions.put(ScriptTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // service task
        activityDrawInstructions.put(ServiceTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // http service task
        activityDrawInstructions.put(HttpServiceTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // receive task
        activityDrawInstructions.put(ReceiveTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // send task
        activityDrawInstructions.put(SendTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // manual task
        activityDrawInstructions.put(ManualTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        activityDrawInstructions.put(BusinessRuleTask.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // exclusive gateway
        activityDrawInstructions.put(ExclusiveGateway.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // inclusive gateway
        activityDrawInstructions.put(InclusiveGateway.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // parallel gateway
        activityDrawInstructions.put(ParallelGateway.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // event based gateway
        activityDrawInstructions.put(EventGateway.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // Boundary timer
        activityDrawInstructions.put(BoundaryEvent.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // subprocess
        activityDrawInstructions.put(SubProcess.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // transaction
        activityDrawInstructions.put(Transaction.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // Event subprocess
        activityDrawInstructions.put(EventSubProcess.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // Adhoc subprocess
        activityDrawInstructions.put(AdhocSubProcess.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // call activity
        activityDrawInstructions.put(CallActivity.class, new DefaultProcessDiagramGenerator.ActivityDrawInstruction() {
        ...
        // text annotation
        artifactDrawInstructions.put(TextAnnotation.class, new DefaultProcessDiagramGenerator.ArtifactDrawInstruction() {
        ...
        // association
        artifactDrawInstructions.put(Association.class, new DefaultProcessDiagramGenerator.ArtifactDrawInstruction() {
